      ...
      <main className="flex flex-col">
        ...
        <section className="relative text-white">
          ...
          <div className="relative z-10">
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-24 min-h-[75vh] flex items-center">
              <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                ...
                <button onClick={handleClick} className="inline-flex items-center bg-indigo-600 hover:bg-indigo-700 px-6 py-3 rounded-lg font-semibold shadow">
        ...
        <section className="bg-gray-200">
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-10 flex flex-wrap items-center justify-center gap-10 md:gap-16">
            <Image src="/variant.png" alt="Next.js" width={120} height={48} className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 transition" />
            <Image src="/variant2.png" alt="Vercel" width={120} height={48} className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 transition" />
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="text-left rounded-xl border bg-white p-6 hover:shadow-lg transition">
                  <div className="bg-indigo-100 w-10 h-10 flex items-center justify-center rounded-md mb-4">
                    <span className="text-indigo-700 font-bold">{phase.svg}</span>
                  </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="bg-gray-900 p-6 rounded-xl shadow-lg text-left border border-white/5">
        ...
        {/* CTA */}
        <section className="bg-indigo-700 text-white text-center py-20 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <button onClick={handleClick} className="bg-white text-indigo-700 font-semibold px-6 py-3 rounded-lg hover:bg-gray-100 shadow">
              Apply Now
            </button>
          </div>
        </section>
