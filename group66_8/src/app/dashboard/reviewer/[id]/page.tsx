...
const initialFormData: ReviewDetails = {
...
export default function ReviewDetailPage() {
  ...
  const [formData, setFormData] = useState<ReviewDetails>(initialFormData);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setFormData(initialFormData); // <-- Clear the form here
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <Link href="/dashboard/reviewer">
              <Button
                variant="outline"
                className="border-0 text-white shadow-none hover:cursor-pointer bg-gray-400 hover:bg-gray-500 hover:text-white"
              >
                Back to Applications
              </Button>
            </Link>
          ...
          <Card className="p-6 sticky top-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="essay_why_a2sv_score">
